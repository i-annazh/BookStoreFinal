...
var resizeSpeed = 7; // controls the speed of the image resizing animations
...
Lightbox.prototype = {
	...
	initialize : function() {
		...
		objLightbox.onclick = function(e) { // close Lightbox is user clicks
											// shadow overlay
			if (!e)
				var e = window.event;
...
/*
 * function pause(numberMillis) { var curently = new Date().getTime() + sender;
